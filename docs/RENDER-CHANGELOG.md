...
* **Chrome против Safari не сравнён.** Safari существует только на macOS, а
  сборка WebKit для Playwright в этом окружении не установлена. Оснастка к
  сравнению готова: `perf-probe.mjs --browser=webkit`. Для настоящего Safari —
  `tools/ext-probe.js` в консоль и вкладка Timelines.
