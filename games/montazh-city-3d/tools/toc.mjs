...
const ROLE = {
  'Конфигурация': 'основа', '0.': 'основа', '1.': 'рендер', '2.': 'геометрия', '3.': 'текстуры',
...
const NOTE = {
  'Конфигурация': 'QCFG — все числа качества: профили, авто-масштаб, частота монитора, текстуры, цвет; Q — активный профиль',
  '0.': 'мелочи и матрицы 4×4 в column-major, как их ждёт GL; lin1/lin3 — sRGB в линейный свет',
  '1.': 'GLSL целиком: VS/FS_MAIN (нормали из surf, triplanar, detail), VS/FS_SKY, VS/FS_GLOW, компиляция и разбор юниформ',
  '2.': 'класс Mesh: box, bevelBox, cyl, ellipsoid, extrudeZ, tube, wheel, сглаживание нормалей, upload в VAO',
  '3.': 'комплекты карт из canvas 2D: albedo (sRGB) + нормаль по Собелю из высот + roughness/metalness + AO; TEXTURE_2D_ARRAY по группам; генерация заданиями между кадрами',
  ...
  '7.': 'R3, Env (солнце и время суток), initRenderer, resizeGL/applyRenderSize (масштаб рендера), Perf (монитор, GPU, авто-масштаб), applyProfile, drawSky, beginMain, bindMaterial/drawMesh, drawStatic',
  ...
  '28.': 'resetWorld, updateWorld, step, frame, Loader и async boot — точка входа внизу файла'
};
