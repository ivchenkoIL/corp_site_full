...
Ещё один самостоятельный подпроект: `games/` — браузерные игры «Монтаж-Сити»
(один файл на игру, без зависимостей и сборки):
[`games/montazh-city/`](games/montazh-city/) — двумерная версия на Canvas,
[`games/montazh-city-3d/`](games/montazh-city-3d/) — трёхмерная, вид от третьего
лица на собственном рендерере WebGL2. К новостям vest-smr.ru отношения не имеют.
...
- `games/montazh-city/` — сатирическая браузерная 2D-игра про вымышленного
  монтажника СКУД и видеонаблюдения. Запускается открытием `index.html`
  без сервера и сборки, см. [README подпроекта](games/montazh-city/README.md).
- `games/montazh-city-3d/` — она же в 3D: вид от третьего лица, собственный
  рендерер на WebGL2 без библиотек, процедурные текстуры и модели,
  см. [README подпроекта](games/montazh-city-3d/README.md).
