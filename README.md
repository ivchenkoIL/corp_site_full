...
Ещё один самостоятельный подпроект: [`games/montazh-city/`](games/montazh-city/) —
браузерная игра «Монтаж-Сити: Трудная смена» (один файл, Canvas + Web Audio,
без зависимостей и сборки). К новостям vest-smr.ru отношения не имеет.
